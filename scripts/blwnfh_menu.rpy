            ...
            frame:
                ...
                vbox:
                    ...
                    viewport:
                        ...
                        text u"alpha 0.1\n" + "Альфа! Что принесла нам Альфа? НИ#$@ она нам не принесла, только эту менюшку с новостями, где будут писаться свежие обновления мода. Это создано для тех, кто не следит за группой.":
                            style "blwnfh_news"
                            size 25
                            kerning 1

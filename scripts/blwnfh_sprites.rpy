...
init 2:
    ...
    python:
        ...
        emotion_to_pose = {
            ...
            'kat': {
                'confused': 1, 'cry': 1, 'smilecry', 'interested': 1, 'normal': 1, 'pockerface': 1, 'sad': 1, 'serious': 1, 'smile': 1, 'joy': 1, 'guilty': 2, 'horny': 2, 'scared': 2, 'shy': 2, 'surprise': 2, 'angry': 3, 'rage': 3, 'grin': 3, 'laugh': 3, 'smile2': 3, 'happy': 4, 'obida': 4, 'thinking': 4, 'upset': 4, 'wr_normal': 5, 'wr_normal_wk': 5, 'wr_smile': 5,
            },
            'sv': {

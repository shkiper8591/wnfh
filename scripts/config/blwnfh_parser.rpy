...
init -2:
    image bg int_dining_hall_day_vedro = blwnfh_fast_composite(im.Scale(blwnfh_ES_IMAGES + "bg/int_dining_hall_day.jpg", config.screen_width, config.screen_height), im.Scale(blwnfh_OTHER + "vedro.png", config.screen_width, config.screen_height))

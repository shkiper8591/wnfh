...
label blwnfh_day_1:
    ...
    "На лице Кати читалось сильное удивление сие событию."
    ...
    kat "Ужасные традиции... {w}Но спасибо хотя бы, что волосы не намочили."
    ...
    "Меня же такие вести нисказанно обрадовали."
    ...
    th "Хотя кого я обманываю... {w}Скорее всего ничего серьезного я сегодня не буду делать."
    th "И какой чёрт дернул меня записаться к ним, я же нихрена не умею, а они инженеры блин."
    th "Валить от них пора, пока Шурик не придумал очередную авантюру на целую неделю."
    th "Только вариантов считай и нет, либо они, либо музыка."
    th "И если выбирать между молчаливыми парнями или бесконечно болтающей ни о чём(хоть и вполне мило) Мику."
    ...
    th "Вот вы значит какая, пионера отправляете выполнять свою работу, под прелогом что не успеваете."
    th "А сама лежит на расслабоне и не парится. {w}Созревает вопрос: что нужно так торопиться сделать, чтобы не успеть забрать новенького?"
    th "У меня вот на это ушло от силы минут пятнадцать, может чуть больше."
    ...
    mt "Всмысле на сушке?"
    me "Её из ведра окатили Алиса с Ульяной."
    
    show mt normal pioneer at right with dspr
    
    mt "Ах, вот оно что[wp] {w}Знала я что перед ними нельзя ничего говорить."
    mt "Ну я им сегодня задам, как только мы закончим тут."
    ...
    stop ambience
    scene bg int_clubs_male_day with dissolve
    play ambience int_clubs_male_day
    show el normal pioneer at left with dspr
    show sh normal pioneer at right with dspr
    
    "К моему возвращению, по всей видимости, Шурик немного пришел в себя."
    "Ведь он на пару с Электроником работали над своим изделием, а если точнее, просто изучали его, видимо думая что с ним делать."
    th "В теории это должен быть робот. {w}Но даже я, человек который в теме полный ноль, иногда задаюсь вопросами о функционале сие машины."
    th "А то пока, выходит, что он полностью бесполезный и максимум что с ним можно сделать, так это показать на какой-нибудь выставке."
    th "Мол: «смотрите какую чудную железную куклу мы смастерили за три недели, которая умеет целое ничего!»"
    th "Ладно, чёрт с этим роботом."
    "Я подошел к своим товарищам."
    
    me "Как успехи?"
    el "Плохо."
    me "Чего так?"
    sh "Да вот, нам не хватает кое-каких деталей, в частности транзисторов и всякого такого."
    ...
    sh "А как туда добираться-то? {w}Пешком я по тридцати градусной жаре идти не собираюсь."
    me "Диллема."
    ...
    me "Тю, предложил он, а доставай я."
    sh "Ты у нас и так главный бездельник, а так хоть каким-то делом займешься."  
    
    "Тяжело вздохнув, я пошел в соседнее помещение, где был вход на чердак."
    ...
    th "Балин, вот же я дурак не спросил, где оно конкретно[wp]"
    th "Да и не то чтобы здесь прямо светло[wp]"
    th "Ладно, прорвемся."
    
    "Я стал обходить и осматривать каждый угол."
    "Но найти в полумраке радио всё никак не получалось."
    ...
    "Подойдя ближе и нашупав здесь старую и твердую как сталь, я снял её."
    "Ощупав объект под этой тряпкой, я сразу понял, что это то самое радио и тут же попытался его поднять."
    ...
    "Вот только я не представлял как спустить радио безопасно, чтобы не повредить его или самого себя."
    
    th "Ну без помощи здесь не обойтись."
    
    me "ШУУУУРИИИК! {w}МНЕ ТВОЯ ПОМОЩЬ НУЖНА!"
    ...
    "Шурик подготовился принимать радио, которое я ему и спустил."
    "Крехтя он поставил его на стол рядом, видимо, чтобы передохнуть, а я спустил вниз."
    ...
    me "Только не знаю насколько, так что может быть уже завтра завхоз вернется."
    
    show sh normal pioneer at center with dspr
    
    sh "Было бы неплохо, чтобы завтра Славя снова была, тогда и можно будет взять нам фонарики."
    ...
    "Притащив радио, мы поставили его на уже заранее заготовленное место."
    ...
    "Электроник достал из ящика стола большую белую тряпку и протянул мне."
    "Я быстренько вытер ей руки, после чего дал Шурику."
    "Тот тоже вытря руки, принялся протирать радио."
    "Под толстенными слоями пыли пряталось полность убитое и проржавевшее радио. {w}Так что были {b}большие{/b} сомнения в том, что из него можно достать хоть что-то полезное."
    ...
    el "Что там?"
    sh "Вся система прогнила насковзь. {w}Добывать здесь нечего, можно спокойно выбрасывать."
    me "И что теперь?"
    sh "Что теперь?"
    
    show sh upset pioneer at right with dspr
    
    sh "Теперь буду думать, где бы нам достать в короткие сроки столь необходимые материалы."
    sh "А пока[wp]"
    
    play sound sfx_dinner_horn_processed 
    
    "Но Шурик не успел договорить, так как послышался горн на обед."
    
    show sh normal pioneer at right with dspr
    
    sh "Ладно, потом скажу. {w}Кстати Семён."
    me "Что?"
    ...
    "И Электроник с Шуриком быстро покинули клубы."
    ...
    "Выйдя, я тут же стал возиться с замком."
    th "По своему качеству он ничем не уступал замку на складе, а даже был хуже."
    th "Ибо его, столь же ловким движением руки с большим напором, закрыть было невозможно."
    th "И приходится страдать, медленно и аккуратно проворачивать ключ, чтобы не сломать его."
    "Провозившись около полутара или двух минут, мне всё же удалось закрыть дверь."
    ...
    "А то в последнее время у меня это не сильно выходило."
    ...
    th "Когда мне приходилось контоваться у родителей из-за потери работы, в связи с чем я не мог оплачивать аренду квартиры."
    th "Тогда мама наварила целую кастрюлю и я почти единолично съел её за три дня[wp]"
    th "И эти щи очень похожи на мамены[wp]"
    
    "За своими раздумиями я не обращал внимания на то, что Лена и Катя о чем-то увлеченно болтали."
    ...
    th "А эта новенькая быстро нашла себе друга(ну или по крайней мере собеседника), не как я."
    th "Интересно, почему именно с Леной? {w}Хотя учитывая как скромно она себя вела и какая стесняша у нас фиолетовая, все вопросы отпадают сами собой."
    
    "За своими размышлениями, суп кончился супер быстро, а за ним и чай."
    ...
    me "А? Нет, мне хорошо, просто после обеда отдохнуть решил немного, да и уснул как-то."
    ...
    un "Д-Да[wp]"
    un "Ты не хотел бы немного прогуляться, Сёмочка?"
    ...
    me "И сейчас после обеда, мне вообще ничего не хочется делать!"
    ...
    me "Слушай, я не против самой идеи погулять, только вот не сейчас."
    
    show un shy pioneer at center with dspr
    
    un "И когда же ты хочешь?"
    me "Что насчёт ммм[wp] {w}Скажем, после ужина, а?"
    me "Вечерком самое же то прогуляться, чтобы нагулять сон."
    
    show un smile pioneer at center with dspr
    
    un "Да, думаю ты прав."
    
    "Лена заметно оживилась."
    
    un "Спасибо Сёмочка, что согласился!"
    me "Та, пожалуйста."
    un "Ну всё тогда, до вечера!"
    me "Ага."
    
    hide un with dspr 
    
    "Она, обогнав меня, ускакала вперед к домикам."
    "А я же только сейчас стал осознавать, что Лена вновь ловко обыграла меня."
    
    th "Твою ж дивизию, на что я только что согласился?"
    th "И ведь отказаться уже будет не удобно[wp]"
    # th "...Блять"
    
    "Вздохнув, я продолжил свой путь к мягкой постели."
    ...
    "И превозмогая себя, я шаг за шагом, поднимался по ступенькам к двери."
    "Двери, которая была так близко и так далеко."
    "Но моих сил мне не хватило и я повалился со ступенек, упав рядом с шезлонгом."
    "Падение было не из приятных, но и не болезнено."
    "И быстренько встав и отряхнувшись, я плюнул на идею лечь дома и улегся на шезлонг."
    ...
    "Да и вдобавок к этому, из-за них становилось понять, кто же комментирует сия матч."
    
    "«Но что же творится! Из неоткуда появляется Ульяна и ловко выхватывает мяч у Алисы!»"
    ...
    "Я перевел всё свое внимание на матч."
    ...
    th "Буквально же миллионы долларов тратятся на человек, которые дай бог десять лет поиграют и всё."
    
    "«До ворот осталось совсем ничего, а Алиса обгоняет Ульяну и[wp]"
    "«УДАР, ГООООЛ! {w}Алиса не успевает спасти ворота и матч оканчивается со счётом два — три в пользу команды Ульяны!»"
    ...
    mi "Всмысле обратно? {w}Спать?! А домой тебя нести кто будет! Точно не я!"
    ...
    "Этим «кто-то» оказалась Лена."
    
    un "О, проснулся наконец."
    me "Привет[wp]"
    
    show un shy pioneer at center with dspr
    
    un "Я тут тебе поесть немного принесла."
    
    "Она протянула мне бумажный сверток, скорее всего с какими-то булками."
    "Я взял его и немного непонимающе посмотрел на Лену."
    
    me "Типо перекус перед ужином?"
    
    show un smile2 pioneer at center with dspr
    
    un "Так ты его проспал, вот я и принесла тебе немного поесть."
    me "Вот как, тогда спасибо, чтобы я без тебя делал."
    un "Голодал бы наверное."
    
    show un shy pioneer at center with dspr
    
    un "Я кстати надеюсь, ты не забыл, что обещал погулять вечером?"
    # me "уааааай биляяяяя забыл.........."
    th "Блин, точно[wp] {w}Как же не хочется[wp]"
    me "Да, помню, только дай я перекушу и мы пойдем куда хочешь."
    
    show un smile pioneer at center with dspr
    
    un "Хорошо."
    
    "Я стал немного возиться на шезлонге."
    "И заняв удобную позицию для употребления пищи, принялся распаковывать её."
    "Лена же села рядом на край ступеньки."
    
    un "Что снилось?"
    me "Да так, фигня какая-то. {w}Какой-то футбольный матч и вроде как проходящий у нас в лагере."
    un "И это фигня? Классно же наоборот!"
    me "Возможно, но мне этот вид спорта не импонирует, так что фигня."
    
    "Тем временем я потихоньку уплетал булку с луком, капустой и яйцом. {w}Вкусняшка."
    
    un "Ну мне как бы тоже, но ведь было бы круто, если у нас проведут матч по футболу."
    me "Ме[wp] {w}Уж лучше пусть какое-нибудь кино покажут."
    me "Не знаю там, Кавказскую пленницу например."
    ...
    th "Я конечно понимаю не увидеть этот фильм, но не слышать о нём вовсе? {w}Как по мне, это нонсенс."
    th "Хотя, может Лена просто не интересуется фантастикой, вот и результат? Но тем не менее."
    
    "К этому времени, я закончил уже есть вторую булку и принялся за последнею, третью."
    ...
    me "Ох, прости Лен, но я подарил всё другу."
    un "Жаль."
    
    "Я же наконец доел булки и, хоть почти не насытился, был готов идти."
    
    show un smile pioneer at center with dspr
    
    un "Ну что, пойдем?"
    me "Да, давай, только куда?"
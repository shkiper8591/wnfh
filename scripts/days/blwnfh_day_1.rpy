label blwnfh_day_1_dream:
    ...
    "Мест свободных вообще не было и меня посадали как раз рядом с той самой девушкой."
    ...
    th "Что, неужели в тридцати градусную жару, от легонького ветерка можно простудится? Едем же мы не 160 в конце концов! {w}Тут дорога такая, что максимум километров сорок будем ехать."
    ...
    "Мне же очень хотелось спать, но также мне было придельно ясно, что эта особа по правую руку не отстанет от меня до тех пор, пока я не обращу на неё внимания."
    "А значит выбора у меня совсем не оставалось[wp]"
    
    nvl clear
    
    me "Что?"
    voice "Как что, знакомится давай! {w}А то я тут несколько часов сижу не знаю чего делать, подруги все на другом конце автобуса сидят."
...
label blwnfh_day_1:
    ...
    me "Спасибо, что хотя бы наполнение другое."
    ...
    mt "Светлана сейчас заняту куда более {i}важными{/i} делами."
    me "Ладно[wp]"
    
    "Я посмотрел на вожатую крайне недовольным взглядом."
    
    th "Неужели у вас, Ольга Дмитриевна, нету хотя бы капельки совести?"
    th "Прямо по среди завтрака дёргаете человека!"
    ...
    scene bg ext_houses_day with slide_right_dissolve2
    ...
    scene bg ext_clubs_day with slide_left_blure_dissolve2

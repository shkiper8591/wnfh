...
label blwnfh_day_1:
    ...
    "Но превозмогая себя, я шаг за шагом, поднимался по ступенькам к двери."
    "Двери, которая была так близко и так далеко."
    "Однако, я всё же справился с этой во истину сложной задачей и смог прорваться во внутрь."
    
    stop ambience 
    scene bg int_house_of_mt_day with dissolve
    play ambience ambience_int_cabin_day
    
    "И внутри, доковыляв до кровати я, не переодеваясь, упал на нее и почти сразу же уснул."
    ...
    "«[wp]и Алиса срывается с ворот вырывая мяч у соперника!»"
    
    me "Что происходит?"
    mi "Ты что, спишь? Футбол идёт!"
    me "А?"
    
    "«Алиса уже близка к воротам соперника и вот вот забьет гол, добыв победу своей команде!»"
    
    mi "Жаль, что ты спал, столько всего интересного пропустил! {w}Но зато это не пропустишь!"
    me "Да, конечно."
    ...
    mi "Ничего не очевидно! Алиса почти успела закрыть ворота!"
    mi "Да и она пошла на такой рисковый шаг и почти принесла победу!"
    me "Всё почти и почти, а что-нибудь наверняка было?"
    mi "Ну да конечно, всё что было наверняка ты проспал дурында!"
    me "Да-да[wp] Ладно, шоу окончилось я обратно."
    mi "Всмысле обратно?"

...
label blwnfh_day_1:
    ...
    th "Это был один из последних дней, когда родители были вместе."
    th "Мы отдыхали на даче и мама наварила огромную кастрюлю супа, которую я почти единолично съел за три дня[wp]"
    ...
    "Я же вздохнув, вновь продолжил свой путь к мягкой постели."
    ...
    "Этим «кто-то» оказалась наша вожатая."
    ...
    "Такое заявление ни капли меня не обрадовало и сделав глаза по пять копеек, я недоумевающе посмотрел на вожатую."
    
    me "Вы же не оставите своего пионера голодным, правда?"
    
    "Но Ольги Дмитриевна ничего не отвечала просто улыбаясь."
    ...
    mt "И так, раз я принесла тебе поесть, то ты должен будешь отработать эту еду."
    
    th "Приехали блин[wp]" 
    
    mt "Поэтому выполнишь завтра одно задание."
    me "Какоэ?"
    ...
    mt "Значит сразу же после завтрака подходишь ко мне."
    me "Хорошо."
    ...
    "Мимо проезжающим, где-то в далеке, поезде." 
    
    stop ambience
    scene bg ext_beach_night with dissovle
    ...
    "Я не слышал, чтобы ко мне кто-то подходил, а голос был незнаком."
    "И на удивление, у меня совсем не было желания повернутся и узнать, кто же там пришел."
    
    me "Не знаю, не должен."
    voice "Уверен? Уже всё таки не день."
    me "Я и без тебя заметил."
    voice "Наблюдательный значит[wp] {w}Это хорошо."
    me "Тут и Шерлоком быть не надо, чтобы заметить, блин, ночь на дворе."
    voice "Кто знает."
    
    "Диалог с незнакомцем строился максимально странный, что немного подвыбешивало меня."
    
    me "Слушай, тебе что надо от меня?"
    voice "Интересуюсь, как у тебя дела."
    me "Хочешь знать как у меня дела? {w}Я уже неделю здесь торчу не по собственному желанию!"
    me "И всю эту неделю, думаю как бы отсюда свалить, попутно не свалившись от жары или малого количества припасов."
    me "Так что, как думаешь, как у меня дела?"
    voice "Да, интересная история у тебя, Семён."
    
    th "Чудесно, он ещё и моё имя знает."
    th "Может это завхоз прикалывается?"
    th "Вот блин деду делать нехер."
    th "Хотя щас мы узнаем, кто позади меня шутки шутит."
    
    me "Да, кто ты блин такой?"
    ...
    "Всё желание побыть здесь подольше улетучилось в миг и я быстрым шагом отправился прочь отсюда."
    ...
    "Только у площади я сбавил свой темп отступления и продолжил путь домой уже обычным шагом."
    "И в дороге я решил обдумать, что же всё таки произошло на пляже."
    
    th "Бесовщина какая-то, что это вообще было?"
    th "Не может же это быть от моего сломанного режима сна!"
    th "Обычно такие мощные галлюцинации когда не спишь пару дней, ну или серьезный недосып."
    th "А у меня ни того, ни другого."
    th "Так что это явно чья-то шутка[wp]"
    ...
    th "Общался со мной какой-то мужчина, только вот[wp]"
    th "Его голос не был похож не на один, который я мог бы знать."
    th "Не то чтобы я знаю здесь каждого, но даже так."

...
label blwnfh_day_1:
    ...
    "Я повернулся назад и в тут же меня врезалась пионерка."
    ...
    "Это была пионерка из соседнего отряда."
    "Примерно на полгода младше меня[wp] {w}Кажется, её Дина зовут."
    ...
    th "Она меня передразнить пытается или что?"
    
    din "Короче, покеда, я не хочу опаздывать на обед."
    
    "Дина убежала в сторону столовой."

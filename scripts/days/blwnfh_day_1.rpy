...
label blwnfh_day_1:
    ...
    "Тот тоже вытерев руки, принялся протирать радио."
    ...
    "За моими размышлениями, я кончил суп довольно быстро."
    ...
    me "И сейчас после обеда, мне очень хочется спать."
    ...
    "«Тем самым матч оканчивается со счётом два — три в пользу команды Ульяны!»"

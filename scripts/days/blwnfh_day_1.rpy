label blwnfh_day_1:
    ...
    mt "А тебе обязательно что-то делать чтоли?! Ну хорошо! Я тебе сейчас найду дело!"
    ...
    th "Интересно, почему она и почему со мной[wp] {w}Может это какая-то шутка?"
    ...
    mt "Светлана по делам уехала в Райцентр."
    ...
    th "Хотя кого я обманываю[wp] {w}Скорее всего ничего серьезного я сегодня не буду делать."

label blwnfh_day_1:
    ...
    #"""
    #$ blwnfh_set_name("uv", "???")
    #play music music_list["mystery_girl"] fadein 5
    #
    #uv "Не замерзнешь?"
    #
    #"Раздался из-за спины вопрос."
    #"Я не слышал, чтобы ко мне кто-то подходил, а голос принадлежкал какой-то незнакомке."
    ...
    #
    #"Диалог с незнакомкой строился максимально странный, что немного озадачивало меня."
    #
    ...
    #uv "Красивое имя[wp]"
    #
    #th "Может это и есть новенькая прикалывается надо мной?"

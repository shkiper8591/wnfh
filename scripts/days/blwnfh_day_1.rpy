label blwnfh_day_1_dream:
    ...
    "Я бегу, бегу не обращая внимания на сильную усталость. Моё тело уже давно просит отдыха, но нельзя останавливаться ни на секунду, ведь {b}он{/b} идёт.\n"
    
    th "Чёртов огнедыщащий утконос, чего же тебе надо от меня?!"

    "\Утконос становилась всё ближе и ближе, а звук его лапок всё более ужасающим."    
    ...
    "А утконос приближался, приближался и[wp]"
...
label blwnfh_day_1:
    ...
    "Но дальше побега от огромного, огнедышащего утконоса в моей памяти ничего не всплывало."
    th "Но там точно было что-то ещё! Вот только[wp] {w}Ай, не помню! Чёрт!"

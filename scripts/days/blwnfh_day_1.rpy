label blwnfh_day_1:
    ...
    "Но у меня совсем не было желания поворачиваться назад и смотреть кто там пришёл."
    
    me "Не знаю, не должен."
    uv "Уверен? Уже всё таки не день."
    me "Я и без тебя заметил."
    uv "Наблюдательный значит[wp] {w}Это хорошо."
    me "Тут и Шерлоком быть не надо, чтобы заметить, блин, ночь на дворе."
    uv "Кто знает. {w}Мне что ночь, что день."
    
    "Диалог с незнакомкой строился максимально странный, что немного подвыбешивало меня."
    
    me "Слушай, тебе что надо от меня?"
    uv "Да вот, интересно, как дела у тебя."
    ...
    th "Её голос не был похож не на один, который я мог бы знать."

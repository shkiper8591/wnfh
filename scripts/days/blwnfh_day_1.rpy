label blwnfh_day_1_dream:
    ...
    "Старый автобус медленно увозит меня в далёкие дали."
    "За окном плывут, приятные глазу, летние узоры полей, лесов. {w}В общем типичной советской глубинки где-то на Поволжье."
    "Солнце же на улице палило как ненормальное, от чего внутри транспорта аж дурно становится. И ещё, как на зло, все форточки закрыты.\n"
    ...
    "\nКто-то окликнул меня справа."
    "Это был явно женский голос и при этом, довольно приятный на слух. {w}Интересно, чего ей надобно от меня?\n"
    
    voice "Э-э-эй! Соня!"
    
    "\nПродолжала она всё тем же приятным голосом."
    "Мне очень хотелось спать, но также мне было придельно ясно, что эта особа по правую руку не отстанет от меня до тех пор, пока я не обращу на неё внимания."
    ...
    voice "А я тут одна считай, не поговорить, ведь ты спишь, и не пересесть поближе к моим друзьям, ибо места все заняты!"
    voice "Короче говоря скука смертная. Поэтому давай знакомится, чтобы уж не так скучно было нам обоим."

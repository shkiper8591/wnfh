label blwnfh_day_1:
    ...
    me "Так, вот он клуб моделирования, я буквально на минуту к товарищам заскачу."
    kat "Моделирования?"
    me "Потом объясню."
    ...
    th "И какой чёрт дёрнул меня записаться в авиамоделисты? {w}Я же нихрена не умею, а они инженеры блин."
    ...
    th "Либо Лена действительно сильно тянула её нос на себя, но в таком случае[wp]"
    th "Зачем такое устраивать ради обычной подколки?"
    th "Надо будет разобраться в этом, если не забуду конечно же."

label blwnfh_day_1_dream:
    ...
    "Однако, всё же меня заметил кто-то из автобуса. {w}Некая рыжеволосая девушка, которая, по всей видимости и передала сообщение водителю и автобус стал медленно сбрасывать скорость.\n"
    ...
    "Когда автобус полностью остановился, я пулей залетел в него и мы продолжили движение."
    
    play music blwnfh_music_list["crows_end"] fadein 5.0 
    
    "Мест свободных вообще не было и меня посадили как раз рядом с той самой девушкой."
    "Она даже освободила мне место у окна, за что я был очень благодарен ей."
    "Расположившись поудобнее я, полностью выбитый из сил и уставший от долгой погони, стал медленно засыпать[wp]"
    "И пока сон медленно утаскивал меня в свои объятия, я наблюдал через окно за, приятными глазу, видами летних полей, лесов. {w}В общем типичной советской глубинки где-то на Поволжье."
    "А ещё солнце на улице палило как ненормальное, от чего внутри транспорта аж дурно становится. А, как на зло, все форточки закрыты!\n"
    ...
    "\nОкликивала меня та самая девушка."
    "Её голос был крайне приятный на слух. {w}Интересно, чего ей надобно от меня?\n"
    
    voice "Э-э-эй! Ты спишь?"
    
    "\nПродолжала она всё тем же приятным голосом."
    "Мне же очень хотелось спать, но также мне было предельно ясно, что эта особа по правую руку не отстанет от меня до тех пор, пока я не обращу на неё внимания."
    "А значит выбора у меня совсем не оставалось[wp]"
    
    me "Что?"
    voice "Как что, знакомиться давай! {w}А то я тут несколько часов сижу не знаю чего делать, подруги все на другом конце автобуса сидят."
    voice "И пересаживаться с места на место, пока автобус в движение, — нельзя. Вот и сижу, скучаю."
    voice "А так хоть тебя подсадили, хоть что-то уж интересное, так что давай знакомится!"
    
    nvl clear
    
    "\nДовольно бодро и задорным голосом говорила девушка."
    ...
    "Всегда пытался сам заводить диалог и как-то его развивать, но в большинстве случаев меня просто динамили. Лишь изредка что-то выходило из всего этого, да и то, не на долго.\n"
    ...
    "\nАдская боль пронзила всё моё тело, а Алиса всё не собиралась останавливаться и пыряла меня и пыряла."
    "Но каким-то чудом, мне до сих пор удавалось сохранять сознание. {w}Чему эта безумная девушка была явно недовольна и с каждым новым ударом прилагала больше усилий и ярости.\n"
    
    dv "Да сдохни ты наконец!"
    
    "\nВыкрикнула она и проткнула ножом мне левый глаз."
    "Этот удар уже был фатальным и я всё таки вырубился."

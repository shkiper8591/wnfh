...
label blwnfh_day_1:
    ...
    "Но самое что удивительно, голос её почему-то звучал очень знакомо."
    "Как будто я где-то его уже слышал, только вот где?"
    "Ладно, оставлю размышления не по теме на потом."
    ...
    th "Вот, блин, деду делать нехрен."

...
label blwnfh_day_1:
    ...
    show cg d1_lineup_no_un with dissolve
    ...
    hide cg d1_lineup_no_un with dissolve
    ...
    th "И тут я понимаю, что всё пиз[wp]"
    ...
    show sv afraid pioneer at right with dissolve
    stop music fadeout 3
    ...
    me "Не, я провалился я и отведу, а ты продолжай мусолить мозги моим товарищам."
    sv "ЧЕГО?! {w}ЧТО ЗНАЧИТ МУСОЛИТЬ!? {w}АХ ТЫ!"
    
    "Я схватил Катю плечо и быстренько повёл её прочь отсюда."

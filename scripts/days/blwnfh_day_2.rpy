...
label blwnfh_day_2:
    ...
    "В общем, мне определенно стоит купить лотерейный билет при первой же возможности!"
    "Но, к сожалению или счастью, долго задерживаться здесь не было ни желания, ни возможности."
    ...
    "И я просто закинул на постель пакет."
    ...
    me "Ладно, а где ты собрался добывать детали, блин, для робота в старом лагере?"
    ...
    th "Бункер? Да и в такой глуши? На кой чёрт?"
    ...
    th "Чёт, я не помню чтобы мне кто-либо рассказывал про такие ГОСТы."
    
    sh "А в бомбоубежище должны быть средства связи и всякого другого рода электроника."
    me "И ты думаешь, там ещё что-то могло остаться?"
    sh "Если ты про марадёров, то не думаю, что в такой глуши они водятся."
    ...
    th "Но бросать товарищей кибернетиков как-то не хочется."

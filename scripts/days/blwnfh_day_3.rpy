...
label blwnfh_day_3:
    ...
    us "Ага!"
    me "Ладно, я согласен, но только если Электроник не придёт в столовую."
    us "А он и не придёт!"
    ...
    "Проснувшись, я, широко распахнув глаза, резко дернулся и вскочил."

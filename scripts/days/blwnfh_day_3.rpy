label blwnfh_day_3:
    ...
    me "Водку?"
    cs "Пакет."
    me "А-а-а[wp] А что со столичной делать? {w}Если не пригодится."
    cs "Не маячить ей перед Олей и всё."
    me "То есть можем себе оставить?"
    cs "Да."
    
    "Я покрутил бутыль и положил его с бантами в пакет."

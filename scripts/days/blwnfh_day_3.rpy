label blwnfh_day_3:
    ...
    "Но b там её не было, однако, я не то чтобы был разочарован данному факту."
    ...
    th "Но это, наверное, единственный сейчас способ узнать где Серый. {w}Конечно, если меня не обманывают."
    
    me "Что, детство в одном месте заиграло?"
    us "Ага!"
    ...
    "Я следил за теми кто входил в столовую, пытаясь найти среди них нашего потеряшку."
    "Но я видел кого угодно, кроме него самого."
    
    th "Видимо парень действительно потерялся[wp] {w}Либо сидит и в тихую ест то, что добыл в столовой."
    ...
    us "Ты меня прекрасно понял, так что не пререкайся."
    
    show us smile with dspr
    
    "Ульяна же была права, руки у меня были большие."
    ...
    th "Вопрос только в том, зачем ей всё это, вроде взрослая уже девушка."

init python:
    blwnfh_gallery_grid = {
        "bg":(
            ...
            (["int_house_of_mt_day_cleaning_4", False], ["ext_underwater", False,], ["int_boathouse_day", False], ["ext_pier_day", False], ["ext_house_of_el_day", False], ["ext_boathouse_sunset", False])
        ),
        "cg":(

...
label d1_sl_probejka:
    ...
    th "Так, надо быть внимательнее и, желательно, оставить все разговоры до нормальной дороги, которая, я очень надеюсь, будет очень скоро."
    ...
    sl "Ладно тогда, отдыхай, но чтобы завтра чтобы повторил, а то ты так всегда будешь запыхаться от легкой пробежки."

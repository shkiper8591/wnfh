...
init -3 python:
    wnfh_characters = {
        ...
        "me":[u"Семён", "#E1DD7D","ikonki_semyon.png"],
        "mi":[u"Мику", "#00DEFF","ikonki_miku.png"],
        ...
        "el":[u"Сергей", "#FFFF00"],
        "un":[u"Лена", "#B956FF","ikonki_lena.png"],
        "cs":[u"Виолетта Церновна", "#A5A5FF"],
        "pi":[u"Пионер", "#E60000"],
        "uv":[u"Юля", "#4EFF00"],
        "voice":[u"... ", "#E1DD7D"],
        # новые персонажи
        "kat":[u"Катя", "#FF97BB","ikonki_katya.png"],
        "gp":[u"Тётя Галя", "#CECECE"],
        "zg":[u"Тётя Зина", "#D199FF"],
        "sd":[u"Сергей Дмитриевич", "#878787"],
        "void":[u" ", "#000000"],
        "sv":[u"Света", "#F3DA0B","ikonki_sveta.png"],
        #"din":[u"Дина", "#080ACE","ikonki_dina.png"],
        # для DLC про деда
        #"cm":[u"Командир", "#"],
        #"olg":[u"Олег", "#"],
        #"part":[u"Партизан", "#"],

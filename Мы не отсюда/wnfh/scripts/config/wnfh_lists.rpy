init -4 python:
    ...
    wnfh_frames_elements = {
        ...
        "yesno_prompt_box_bg":                    [wnfh_gui["tint_elements"]["frame_bg"]            ,1000          ,200         ,25                ,2             ,frame_black        ,wjuh_bg],
        "yesno_prompt_box_line":                  [wnfh_gui["tint_elements"]["frame_line"]          ,1020          ,4           ,22                ,1             ,frame_green      ,wjuh_line],
        "yesno_prompt_button_bg":                 [wnfh_gui["tint_elements"]["frame_bg"]            ,250           ,60          ,25                ,2             ,frame_black        ,wjuh_bg],
        ...
        "game_menu_selector_button_bg":           [wnfh_gui["tint_elements"]["frame_bg"]            ,480           ,50          ,25                ,2             ,frame_black        ,wjuh_bg],
        "game_menu_selector_button_line":         [wnfh_gui["tint_elements"]["frame_line"]          ,500           ,4           ,22                ,1             ,frame_green      ,wjuh_line],
        "game_menu_selector_button_gradient":     [wnfh_gui["tint_elements"]["frame_gradient"]      ,480           ,50          ,25                ,0             ,frame_blue        ,wjuh_bg],
        "widget_lp_box_bg":                       [wnfh_gui["tint_elements"]["frame_bg"]            ,1700          ,100         ,25                ,2             ,frame_black        ,wjuh_bg],
        "widget_lp_box_line":                     [wnfh_gui["tint_elements"]["frame_line"]          ,1720          ,4           ,22                ,1             ,frame_green      ,wjuh_line],
        "widget_clock_box_bg":                    [wnfh_gui["tint_elements"]["frame_bg"]            ,140           ,50          ,25                ,2             ,frame_black        ,wjuh_bg],
    ...
    wnfh_gui["map"] = {img:(wnfh_MAP + img + ".png") for img in [
        "map",
        "map_available",
        "map_selected",
        "map_mask",
...
init 1:
    ...
    $ wnfh_music_list["angus_story"]                            = wnfh_MUSIC + "Alec Holowka - Angus Story.mp3"

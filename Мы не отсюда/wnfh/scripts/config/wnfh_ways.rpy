init -4 python:
    ...
    wnfh_GUI = wnfh_SOUND + "gui/"
    
    wnfh_ES_IMAGES = "images/"
    wnfh_IMAGES = wnfh_ROOT + "images/"
    wnfh_ACHIEVEMENTS = wnfh_IMAGES + "gui/achievements/"
    wnfh_BANNERS = wnfh_IMAGES + "gui/banners/"
    wnfh_MAIN_MENU = wnfh_IMAGES + "gui/main_menu/"
    wnfh_GALLERY = wnfh_IMAGES + "gui/gallery/"
    wnfh_SAVELOAD = wnfh_IMAGES + "gui/save_load/"

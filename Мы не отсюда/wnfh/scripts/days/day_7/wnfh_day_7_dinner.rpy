label d7_zavtrak:
    ...
    if wnfh_Data.getChoice_result_number("d7_choice_n1") == 1:
        "Пришёл я в столовую немного припозднившись, но свободные места ещё оставались."
    else:
        "Пришёл я в столовую чуть ли не одним из первых — свободных мест было хоть отбавляй."
    "Но не успел я взять свой завтрак, как почти все их уже позанимали."
    
    th "И как только успевают-то?"  
    
    "Среди хотя бы немного знакомых мне людей свободное место было напротив Алисы и Ульяны."
...
label d7_un_zavtrak:
    ...
    "Лена сидела и медленно уплетала свой завтрак, не обращая на меня никакого внимания."
    ...
    if wnfh_Data.getChoice_result_number("d7_choice_n1") == 1:
        ...
        "Похоже, Лена только сейчас обратила внимание на мой внешний вид, так как осматривала она меня с нескрываемым удивлением."
        ...
        me "Да пустяки. {w}Но в следующий раз передай своим родителям, чтобы полегче чемоданы выдавали."
    ...
    if wnfh_Data.getChoice_result_number("d7_choice_n1") == 1:
        ...
        mt "Ох, мне, конечно, Славя сказала, что ты упал, но что всё настолько серьёзно[wp]"
...
label d7_un_yes_2_lbl:
    ...
    me "Только тебе следует поторопиться."
    me "Я вот уже почти всё съел, а у тебя ещё полтарелки."

    show un serious pioneer with dspr

    un "Да[wp] {w}Не хочу я овсянку эту. Сколько можно её давать?"
    ...
    me "Как-то не обратил внимания. Да и неважно, давай скорее разберёмся с пополнением и всё."
...
label d7_dv_usw_zavtrak:
    ...
    th "Конечно, сидеть с рыжими было сомнительным удовольствием, ибо они – те ещё любители колких шуток."
    ...
    "Усевшись за стол, я бегло изучил свой завтрак."
    ...
    "Свою шутейку Ульяна выдала весьма громко, от чего некоторые пионеры поблизости странно покосились на нас."
    ...
    me "Я вас слушаю."
    mt "Доедай быстрее и иди на остановку."
    me "А зачем?"
    
    "Вожатая посмотрела на двух рыжих пионерок, будто не желая при них рассказывать."
    "Но, тяжело вздохнув, продолжила."
    ...
    mt "Светлана сейчас занята куда более важными делами."
    me "Ладно[wp]"
    ...
    th "А вот такое предложение звучало куда интереснее. {w}Таки и надо было с этого начинать!"
    ...
    "Я не очень понял, что она под этим подразумевала."

    th "Мне вот известно, как костёр по-пионерски тушить. Очень надеюсь, что Алиса имеет в виду что-то другое."
    ...
    "Резко вставившая свои пять копеек Ульяна развеяла мои опасения."
...
label d7_dv_yes_1:
    ...
    "Взвесив все за и против, я решил, что оно того стоит."
...
label d7_dv_no_1:
    ...
    "Я же принялся за завтрак с удвоенной силой, и уже через минуту от него ничего не осталось."
    ...
    "Помохав рукой на прощание, я быстро удалился из столовой."

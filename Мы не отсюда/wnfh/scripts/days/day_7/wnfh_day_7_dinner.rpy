...
label d7_un_zavtrak:
    ...
    if wnfh_Data.getChoice_result_number("d7_choice_n1") == 1:
        ...
        "Похоже, Лена обратила внимание на мой внешний вид, так как осматривала она меня с нескрываемым удивлением."
    ...
    "Проговорила она, слегка запыхавшись."
...
label d7_un_yes_2_lbl:
    ...
    un "Да[wp] {w}Не хочу я овсянку эту. Сколько можно её подавать?"
...
label d7_dv_usw_zavtrak:
    ...
    "Хитрым голосом отозвалась Ульянка."
    ...
    "Я не очень понял, что она имела в виду."

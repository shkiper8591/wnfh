label d7_me_kat_sdacha_kati_w_un:
    ...
    "Вернее, у дома. Она лежала в шезлонге и читала какую-то книгу."
...
label d7_un_no_1_lbl:
    ...
    if wnfh_Data.getChoice_result_number("d7_choice_n1") == 1:
        me "Да и не очень хочется гулять, будучи обмазанным йодом."
        un "Да[wp]"
...
label d7_un_neutral_1_lbl:
    ...
    me "До обеда ещё далеко, много чего может случиться. {w}Дел могут навалить на меня, например."

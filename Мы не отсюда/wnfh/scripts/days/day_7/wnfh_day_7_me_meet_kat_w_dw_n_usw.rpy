label d7_me_meet_kat_w_dw_n_usw:
    ...
    th "Значит приехали уже[wp] Значит, времени на подготовку засады немного[wp] {w}Надеюсь, Ульяна быстро придёт."
    ...
    "Местечко действительно было неплохим[wp] {w}Чтобы играть в прятки или типа того."
    ...
    dv "Давай, залезай под чёртово дерево и не задавай вопросов, времени мало!"
    ...
    "И, на удивление, я никак не поранился о ветки, а за кустами было много свободного места."
...
label d7_sh_no_1:
    ...
    me "Слушай, меня знатно так подставили Алиса с Ульяной, пусть они извиняются!"
    ...
    me "Слушай, мне вожатая велела сопроводить пополнение, а если попытаюсь свалить на кого-нибудь, мне такое устроят[wp]"
    ...
    sv "Поскольку ты не справился со своей задачей сопроводить пополнение в целостности и сохранности[wp]"

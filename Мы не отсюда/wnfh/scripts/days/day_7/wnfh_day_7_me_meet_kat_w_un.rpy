label d7_me_meet_kat_w_un:
    ...
    th "И если там много пионеров, то даже вдвоём мы можем со всеми не справиться."
    ...
    un "Три или четыре пионера максимум."
    ...
    "И были малость удивлены, обнаружив здесь только одного пионера. {w}Вернее, пионерку."
    ...
    "Сказал я и без промедления отправился в клуб."
    ...
    th "Охренеть, вот это он вырыл себе могилу. Просто титанических масштабов."

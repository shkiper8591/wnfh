label d7_me_meet_kat_w_un:
    ...
    un "Сомневаюсь, что нас ждёт особо большое пополнение. Три или четыре человека максимум."
    ...
    "Вскоре мы подошли к пункту назначения."
    ...
    "Отвечала девушка с запинками, явно смущаясь."
    ...
    "Было видно, что она стала немного увереннее в себе, даже улыбаться начала."
    ...
    "Не став тянуть время объяснениями, я направился в клуб."
    ...
    "Её взгляд упал на модели самолётов."
    ...
    th "Да уж, быстро ты находишь цель."
    ...
    "Света же нас не преследовала и осталась далеко позади."
    ...
    "От неожиданного возгласа Кати мы с Леной аж вздрогнули."

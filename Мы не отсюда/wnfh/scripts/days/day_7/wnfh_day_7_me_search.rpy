...
label d7_me_search_dv_sport:
    ...
    th "Думаю, там есть шанс их встретить, раз они так любят заниматься спортом."
    ...
    "Славяна занималась разными спортивными упражнениями: приседания, бег на месте и всякое такое."
...
label d7_me_search_dv_house:
    ...
    th "Вот чёрт[wp] И что же теперь делать?"

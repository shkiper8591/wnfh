...
label d7_obed_me_alone:
    ...
    if wnfh_Data.getChoice_points_sum("un") <= 0: 
        ...
        un "Ну-с, тогда не будем мешать. {w}Приятного аппетита!"
        me "Спасибо большое."
...
label d7_obed_me_w_un_kat:
    ...
    th "Интересно, почему именно Лена? {w}Хотя учитывая как скромно она себя вела и какая стесняша у нас Тихонова, все вопросы отпадают сами собой."

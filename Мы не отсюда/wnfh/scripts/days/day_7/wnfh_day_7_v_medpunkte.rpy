label d7_me_v_medpunkte:
    ...
    show cs normal medcoat glasses at center with dissolve
    ...
    show cs normal medcoat with dspr
    play sound sfx_open_table

    "Открыв ящик стола, Виола стала копаться в нём."
    ...
    "Она указала на умывальник позади меня."

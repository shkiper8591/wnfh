label d8_begunok_canon:
    ...
    "Собственно, ради того, что сохранить ваше хорошее настроение, я предлагаю вам сделку."
    "Вы не заставляете меня писать две тысячи строк о захватывающем дух заполнение бегунка. А я, в свою очередь, не заставляю вас это читать."

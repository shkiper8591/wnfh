label d8_boevaya_zadacha:
    ...
    kat "Вроде «Кажется, ошибочка вышла», а после, всучив ведро мне в руки, убежала вместе с Ульяной."
    ...
    me "Не особо, кроме тех, что наверху лежали[wp]"
...
label d8_boevaya_zadacha_1:
    ...
    kat "Просто, знаешь, было такое чувство[wp] Обиды, что ли?"

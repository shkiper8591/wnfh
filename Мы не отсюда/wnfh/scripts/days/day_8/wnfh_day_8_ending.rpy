...
label d8_ending_dv:
    ...
    show mt walk_2 wlk background with dissolve

    "На лице её читались глубокие раздумья."

    show mt walk_3 wlk background with dissolve

    "И немного злости."

    show mt walk_4 wlk background with dissolve
    ...
    mt "Простила сломанный после ваших с Алисой выходок бойлер."

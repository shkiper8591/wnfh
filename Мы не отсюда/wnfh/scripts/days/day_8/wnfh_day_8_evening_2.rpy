...
label d8_evening_2_w_dv:
    ...
    "Скоро послышался тихий хруст и Алиса отворила дверь."
    "Она сунула отвертку под ремень."
    ...
    me "Ты же понимаешь, что за такое Мику ещё сильнее обидется на тебя?"
    ...
    "В лунном свете отчетливо было видно переливающиеся на полу аквамариновые волосы."
    "А опустив взгляд чуть ниже, я разглядел на полу и саму постель, в которой тихо мирно спала Мику."

    th "Ну и дела[wp]"

    dv "Ну чё ты там встал? Призрака увидел чтоле?"

    "Пришипела шёпотом позади Алиса и выглянула из-за моего плеча."
    ...
    th "Меня и Алису может, в полумраке, Мику и не разглядит, но шума поднимет достаточно."
    th "А мне это ой как не хочется."

    "Тем временем Алиса тихонько пробралась вглубь помещения, и уже была на полпути к гитарам."

    th "Однако, быстро она."

    "Пройдя ещё пару шагов, она аккуратно вытянулась вперёд и схватила две гитары."
    "Оставалось дело за малым, — поднять их."
    "Но тут была главная загвоздка. Вокруг было полной других инструментов и одно неловкое движение могло вызвать эффект домино."

    th "Надеюсь, ей хватит ловкости и осторожности."

    "И в эту же секунду наша соня начала ворочатся во сне, из-за чего сложилось ощущение что она вот-вот проснётся."
    ...
    th "Чёрт, пробежался так немного, а лёгкие с сердцем уже пишут завещание."

    dv "Ты как там?"
    me "Нормально, нужно только перевести дыхание."
    dv "Может тебе со Славей по утрам бегать?"
    ...
    th "Мало того, что совершили ограбление, так и ещё надо придумать что сыграть!"
    th "Ну ладно, есть у меня тут одна мысль."

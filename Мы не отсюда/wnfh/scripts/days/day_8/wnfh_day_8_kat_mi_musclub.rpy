label d8_kat_mi_musclub:
    ...
    th "Похоже, не я один не в курсе."
    ...
    if persistent.wnfh_mat_filter == 0:
       ...
       th "Вот блять, как не вовремя-то!"

    elif persistent.wnfh_mat_filter == 1:

        th "Вот б@$#ь, как не вовремя-то!"

    else: 
            
        th "Вот зараза, как не вовремя-то!"
    ...
    me "Дамы, что вам известно о таком понятии как {i}юмор{/i}?"
    ...
    mi "Эх, Семён, что тебе известно о таком понятии как {i}юмор{/i}?"
    ...
    play sound wnfh_sfx_list["sugar_stir"]
    ...
    dv "Приветствую, товарищи музыканты."
    mi "Приветик!"
    ...
    call screen wnfh_choice(
        ["dv", "А давай!", "Я как раз вспомнил, как играть", "d8_me_dv_yes_near_musclub", {"dv":1, "mi": -1}],
        ["mi", "О, нет-нет-нет!", "Это точно закончится проблемами", "d8_me_dv_no_near_musclub", {"dv":-1, "mi": 1}],

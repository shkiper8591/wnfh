label d8_obed_me_alone_alt:
    ...
    "Она пошла к себе домой, вероятнее всего, делиться яблоками с Ульяной."
    "А я же, прикинув, что до обеда осталось всего ничего, пошёл к столовой."
    "Там, усевшись на лавочку, я стал ожидать начала великого жора."
    "Но до тех пор нужно было себя чем-то занять[wp]"
    
    th "Интересно, что же всё-таки искали те люди в химзащите? Да и ещё так близко к лагерю[wp]"
    ...
    "Время же шло предательски медленно."
    ...
    th "То товарищи моделисты ко мне подсаживаются, то я к ним[wp]"

    "Обед я закончил в кратчайшие сроки."

    th "Но всего хорошего помаленьку[wp]"
...
label d8_obed_me_dv:
    ...
    "Алиса было потянулась в свой «карман», но резко остановился."
    ...
    "С ноткой сарказма проговорила Алиса."
...
label d8_obed_me_kat_un:
    ...
    "Усевшись за стол, я, будучи голодным как волк, сразу же накинулся на свой обед."
...
label d8_obed_me_kat_mi:
    ...
    "Зайдя в столовую, я отработал стандартную, уже отработанную схему."
    ...
    "Насмешливо сказала Катя, указывая взглядом на пятно на моей рубашке."
    ...
    kat "Ой, знаешь, Мику, мне только нужно будет отойти к себе в домик. Буквально на десять минут, ладно?"
    ...
    mi "Отлично, буду ждать вас обоих тогда!"
...
label d8_obed_me_kat:
    ...
    "Последние слова вырвались сами собой, и я даже как-то не подумал, что мог бы обидеть девчонку."
    ...
    call screen wnfh_choice(
        ...
        ["neutral", "Лучше не тревожить", "Иногда лучше оставить человека в покое", "d8_obed_me_kat_2", {None}],

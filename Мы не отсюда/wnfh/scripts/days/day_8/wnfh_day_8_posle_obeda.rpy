label d8_posle_obeda:
    ...
    th "М-да[wp] Интересно, как там сейчас дома? Наверное, всё также сыро да холодно, северная столица же."
    ...
    if wnfh_Data.FlagGet("d8_begunok") == False:
        ...
        th "Похоже, вожатая тоже незаметила как я вошёл в домик[wp] Забавно."

        me "Что-то случилось?"
        
        show mt normal pioneer at center with dspr

        mt "Не совсем, просто есть дело и мне нужна в нём помощь."
        me "Дело срочное?"
        mt "Да."
...
label d8_posle_obeda_mt_angry:
    ...
    mt "И так, Семён, весь следующий день, после завтрака, с перерыром на обед и до ужина, будешь ты[wp]"

    show mt smile pioneer at center with dspr

    mt "Красить деревья!"

    "Я посмотрел на вожатую подозрительным взглядом."

    me "Все?"
    mt "Ну только те, что на территории лагеря и на воротах."
    me "Ясно[wp] Что ж, ладно."

    show mt smile pioneer at center with dspr

    mt "Вот и славненько."
    mt "Завтра подойдёшь к складу, тебе дадут всё необходимое."

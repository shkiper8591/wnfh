...
label d8_zavtrak_w_un:
    ...
    kat "А то, что я даже вещи свои толком распределить по местам не успела, это не?"
...
label d8_zavtrak_s_el_sh:
    ...
    me "Как идут у вас дела? {w}Придумали, как добыть детали?"
    ...
    "И очень не хотелось бы, чтобы она услышала наши разговоры о старом лагере."
    ...
    mt "Семён, давай, доедай скорее и марш на выход, там тебя уже ждут!"
    ...
    "Вожатая удалилась так же скоро, как и пришла."

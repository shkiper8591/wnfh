...
label d8_zavtrak_s_miku:
    ...
    "Обычно, после такого меня распирает любопытство, и я начинаю доставать людей просьбой рассказать, что там такое."
    "Но, сейчас завтрак, да и Мику как-то доставать не хотелось."

label wnfh_day_9:
    ...
    window show
    ## Пробуждение Семёна3
    "Аттентион, вы входите в зону старого сценария, можете продолжить читайте на свой страх и риск!"
    ...
    "И она поняла, что кое-кто пытался избежать присутствия на линейке."
    ...
    "Но до меня до сих пор не доходила главная мысль всего диалога."
    ...
    show sh normal with dspr
    # тут надо заменить перекись на спирт и сделать диалог аля "где мне найти спирт" ну и достижение в конце всего этого вставить "в поисках спирта"
    ...
    th "Блин, на другой конец лагеря переться[wp]"
    ...
    "Алиса вышла со сцены и спрыгнув ко мне, легонько стукнула по плечу."
    ...
    "Выглядела она довольно грозно, что я даже немного отступил назад."
    ...
    me "Ну не знаю, может какая-нибудь колкая шутка или что-то типа такого."
    ...
    "Схватив гитару поудобнее, мы отправились в путь."
    ...
    "Женя протягивала мне самый настоящий «полароид»!"
    ...
    th "А потом можно будет пойти прогуляться чтобы, так сказать, развеяться после незадавшегося диалога с Леной."
    ...
    me "Видимо, из легко доступных — нет."
    
    "Тем временем мы дошли до Катиного домика."
    ...
    me "Так что, у тебя найдётся место для меня? Или мне лежать на голой земле и отмораживать спину?"
    kat "Найдётся, давай ложись под одеялку за мной."

label d9_editorial:
    ...
    kat "А я Екатерина. Но лучше просто Катя."

    show mz fun pioneer glasses at left with dspr

    mz "Хорошо просто Катя, идёмте, покажу вам ваше рабочее место."
    ...
    "Катя по-дружески приобняла её, а я в это время присел напротив нашей музыкантки."
    ...
    mz "Ладно, порадовались маленькой победе, а теперь пора на ужин идти."

label d9_editorial:
    ...
    usw "Так вы же вроде музыканты, или вы собираетесь петь серенаду об спортзале?"

    show usw laugh2 sport2 at right with dspr

    usw "Или быть может вдарите бодрого року? Это было бы вообще отлично!"

    "Я и Катя недоумевающе переглянулись."
    ...
    usw "Ой, ладно-ладно[wp] Не знаю даже что сказать. {w=1.0}Наверное, успехи у нас пока скромные."

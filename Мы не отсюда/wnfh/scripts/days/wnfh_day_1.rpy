...
label d1_un_progulka:
    ...
    me "Ну как, занимаюсь, я там скорее для вида, ведь всё разработку на себе тащит Шурик."
...
label d1_un_yes_3_lbl:
    ...
    cs "А теперь прошу покинуть всех помещение кроме тебя, Лена."
    cs "Думаю, мне не помешает твоя помощь."
    ...
    cs "Что ж, пионэр[wp] Давай-ка займёмся тобой."

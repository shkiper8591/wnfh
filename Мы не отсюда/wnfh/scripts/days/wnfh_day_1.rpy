...
label d1_sl_probejka:
    ...
    "Виолла стояла напротив шкафа с медикаментами с журналом в руках, где она делала пометки."
    ...
    "Виолла взглянула на меня через очки."
    ...
    "Я медленно прошелся по помещению медпункта и уселся на кушетку."
    ...
    me "А у вас есть такие инструменты?"
    ...
    "Вернувшись ко мне, Виола стала протирать полотенцем мои раны."
    "И прохлада от влажного полотенца давала просто прекрасные ощущения."

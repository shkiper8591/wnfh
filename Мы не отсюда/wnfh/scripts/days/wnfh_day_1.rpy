...
label d1_me_meet_kat_alt:
    ...
    th "А то я её облил, а даже имени не знаю."
    
    me "Кстати, как тебя зовут?"
    
    "В ответ глухая тишина."
    
    th "Видимо, придётся предпринять немного другую, так скажем, стратегию[wp]"
    ...
    me "Да где такое вообще видано, наверняка думаешь ты."
    me "Но ты ещё легко отделалась, вот что я скажу, ведь тебе не пришлось бежать за быстро удаляющимся вдаль автобусом, в отличии от меня."
    ...
    me "И тем не менее, моё мнение об лагере уже было испорчено!"
    ...
    sl "Конечно, полное имя Славяна, но мне нравится когда меня зовут Славей всё же."
    kat "Хорошо, запомню."
    ...
    "Через несколько секунд, Славя подошла к нам и протянула Кате пионерскую форму."
    ...
    th "Блин, чего я такого сделал, что они меня так подставили[wp] {w}Надо бы вспомнить, что было вчера[wp]"
    ...
    th "Мы же с Алисой и Ульяной договаривались прогуляться по лагерю и сыграть в карты, но в эти планы вмешалась Лена. {w}Возможно это и есть причина подставы, вот только никто не указывал этого."
    ...
    th "Ладно, чёрт с ними пока-что, потом разберусь."
    
    "Я встал и подошёл к ней."
    
    me "Ну что, пошли отведу тебя к вожатой теперь."

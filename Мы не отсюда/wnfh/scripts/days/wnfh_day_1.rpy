...
label d1_un_yes_3_lbl:
    ...
    cs "Кхм, я попросила всех покинуть помещение, Тихонова."
    ...
    cs "Так-с, раз ты у нас очнулся, то, Лена, можешь идти по своим делам."

    show un shy pioneer at right with dspr

    un "Х-Хорошо[wp] {w}Скорее поправляйся Сёмочка."

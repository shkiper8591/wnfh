init 2:
    screen wnfh_choice(*args):
        ...
        python:
            def add_to_bd(data):
                wnfh_Data.write(str(data[1][0]),{"Название выбора":str(data[1][1]),"Выбранно":data[2]+1,"Текст выбора":data[0][1],"Влияние на персонажей":data[0][4],"Query":wnfh_Data.get(str(data[1][0]))["Query"]})

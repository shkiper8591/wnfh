        ...
        viewport id "save":
            ...
            vbox:
                ...
                for slot_num in range(10):
                    $ slot_info = wnfh_get_slot_extra_data("{}-{}".format("WNFH_Saves", slot_num))
                    button:
                        xysize(wnfh_frames_elements["save_load_element_bg"][1], wnfh_frames_elements["save_load_element_bg"][2])
                        style "wnfh_buttons"
                        background Frame(
                            Transform(
                                wnfh_frames_elements["save_load_element_bg"][0],
                                matrixcolor = TintMatrix(wnfh_tint_color[renpy.store.wnfh_tymeofday][wnfh_frames_elements["save_load_element_bg"][4]])
                                ),
                            left = wnfh_frames_elements["save_load_element_bg"][3],
                            top = 0
                            )
                        foreground Frame(
                            Transform(
                                wnfh_frames_elements["save_load_element_double_line"][0],
                                matrixcolor = TintMatrix(wnfh_tint_color[renpy.store.wnfh_tymeofday][wnfh_frames_elements["save_load_element_double_line"][4]])
                                ),
                            left = wnfh_frames_elements["save_load_element_double_line"][3],
                            top = 6
                            )
                        hover_background Fixed(
                            ...
                            Frame(
                                Transform(
                                    wnfh_frames_elements["save_load_element_gradient"][0],
                                ...
                                left = wnfh_frames_elements["save_load_element_gradient"][3],
                                top = 0
                                ),
                            Frame(
                                Transform(

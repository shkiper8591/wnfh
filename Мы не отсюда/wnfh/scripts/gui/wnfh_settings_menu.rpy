...
init 2:
    screen wnfh_preferences():
        ...
        python:
            ...
            wnfh_bars = {
                "htumb": [im.MatrixColor(wnfh_gui["tint_elements"]["bar_htumb"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 1, renpy.store.tymeofday)))],
                
                "bar_full": [im.Composite(
                    (473, 37),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["bar_full"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 0, renpy.store.tymeofday))),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["bar_null"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 1, renpy.store.tymeofday))),
                    )],

                "bar_null": [im.Composite(
                    (473, 37),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["bar_bg"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 2, renpy.store.tymeofday))),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["bar_null"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 1, renpy.store.tymeofday))),
                    )],

                "button_bar_full": [im.Composite(
                    (145, 35),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["button_bar_full"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 0, renpy.store.tymeofday))),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["button_bar_null"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 1, renpy.store.tymeofday))),
                    )],

                "button_bar_null": [im.Composite(
                    (145, 35),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["button_bar_bg"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 2, renpy.store.tymeofday))),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["button_bar_null"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 1, renpy.store.tymeofday))),
                    )],

                "multibutton_bar_full": [im.Composite(
                    (248, 35),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["multibutton_bar_full"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 0, renpy.store.tymeofday))),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["multibutton_bar_null"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 1, renpy.store.tymeofday))),
                    )],

                "multibutton_bar_null": [im.Composite(
                    (248, 35),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["multibutton_bar_bg"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 2, renpy.store.tymeofday))),
                    (0, 0), im.MatrixColor(wnfh_gui["tint_elements"]["multibutton_bar_null"], im.matrix.tint(*converter_hex('wnfh_choice_tint_color', 1, renpy.store.tymeofday))),
                    )],
            }
